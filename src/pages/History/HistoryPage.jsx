...
const HistoryPage = () => {
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.hero} style={{backgroundImage:"url(/Images/site-images/the-journey.jpg)",backgroundSize:"cover",backgroundPosition:"center",backgroundAttachment:"fixed"}}>
