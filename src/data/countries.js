...
// Exact copy of the backend's COUNTRY_CHOICES (jobs/constants.py, frozen in
// migrations/0002_expand_application_schema.py). The `country` field on
// JobApplication is a strict 2-letter choices field — sending a code not in
// this list will fail validation, so keep this in sync with the backend.
...
const countries = [
  ...
  ["RO", "Romania"], ["RU", "Russian Federation"], ["RW", "Rwanda"], ["RE", "Réunion"],
  ...
  ["TC", "Turks and Caicos Islands"], ["TV", "Tuvalu"], ["TR", "Türkiye"], ["UG", "Uganda"],
